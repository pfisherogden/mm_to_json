...
class Event:
    ...
    def save(self, db):
        ...
        mdb_writer.add_event(db, e_id, self.session_num, self.number, self.distance, self.stroke, self.gender, self.meet_id, 
                             i_r=i_r, age_low=self.age_low, age_high=self.age_high)
...
class Entry:
    ...
    def save(self, db):
        ...
        mdb_writer.add_entry(db, e_id, self.athlete_id, self.event_id, self.team_id, 
                             heat=self.heat, lane=self.lane, meet_id=self.meet_id, i_r=i_r)
...
class RelayTeam:
    ...
    def save(self, db):
        ...
        new_id = mdb_writer.add_relay_team(db, r_id, self.meet_id, self.team_id, self.letter, self.gender, 
